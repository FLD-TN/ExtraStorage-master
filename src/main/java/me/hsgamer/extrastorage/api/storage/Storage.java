...
public interface Storage {
    ...
    default UUID getUniqueId() {
        return UUID.randomUUID(); // Default implementation
    }
    ...
    /**
     * <p>
     * Unfilter the specified item. If the quantity of that item is less than 1, it
     * will be removed from the storage,
     * otherwise, it still in the storage until it is withdrawn all of them.
     * </p>
     * <p>
     * To make the item to be filtered (if and only if that item still in the
     * storage),
     * please take a look at: {@link Item#setFiltered(boolean)
     * Item#setFiltered(boolean)},
     * otherwise, you have to use {@link Storage#addNewItem(Object)
     * Storage#addNewItem(Object)}
     * </p>
     *
     * @param key the item key. Can be an ItemStack or a string as MATERIAL:DATA
     ...
     *
     * @param key      the item key. Can be an ItemStack or a string as
     *                 MATERIAL:DATA
    ...
    /**
     * Subtract the item quantity. For unfiltered items, if the quantity is less
     * than 1 after subtracted,
    ...
    /**
     * Set the item quantity. And same as {@link Storage#subtract(Object, long)
     * subtract(Object, long)} method,
     * for unfiltered items, if the quantity is set less than 1, it will be
     * automatically removed from the storage.
     *
     * @param key      the item key. Can be an ItemStack or a string as
     *                 MATERIAL:DATA
    ...
    /**
     * Reset the item quantity (can be null to reset all items). And same as
     * {@link Storage#subtract(Object, long) subtract(Object, long)} method,
     * for unfiltered items, after reseting, it will be automatically removed from
     * the storage.
     *
     * @param key the item key. Can be an ItemStack, a string as MATERIAL:DATA or
     *            null for all items
     * @see Storage#add(Object, long)
     * @see Storage#subtract(Object, long)
     * @see Storage#set(Object, long)
