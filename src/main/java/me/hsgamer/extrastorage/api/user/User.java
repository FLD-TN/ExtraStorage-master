...
public interface User {
    /**
     * Kiểm tra xem có yêu cầu partner đang chờ từ player này không
     * 
     * @param player UUID của người gửi yêu cầu
     * @return true nếu có yêu cầu
     */
    boolean hasPendingPartnerRequest(String username);

    void addPendingPartnerRequest(String username);

    void removePendingPartnerRequest(String username);

    Collection<String> getPendingPartnerRequests();
